...
export async function trackBrandInDeepSeek(keyword: string, brand: string, count = 5) {
  console.log(`Starting brand tracking in DeepSeek for keyword: "${keyword}", brand: "${brand}"`)

  // Select random variations up to the requested count (only 5 for DeepSeek)
