...
export function ChatGPTResults({ results }: { results: SearchResult }) {
  ...
  if (results.searchCount === 0) {
    return <p className="text-gray-600">No ChatGPT results found for this keyword.</p>
  }

  if (results.foundCount === 0) {
    return (
      <p className="text-gray-600">ChatGPT responses generated, but your brand was not mentioned in any results.</p>
    )
  }
